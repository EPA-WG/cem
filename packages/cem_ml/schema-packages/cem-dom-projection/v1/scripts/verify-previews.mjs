...
const packageLabel = 'CEM DOM Projection Schema Package';

const cases = [
    sourceFallbackCase('basic-dom', 'basic-dom.cem-bin'),
...
function sourceFallbackCase(id, file) {
    return {
        ...
        renderer: 'text',
        sourcePath: `packages/cem_ml/schema-packages/cem-dom-projection/v1/examples/${file}`,
        width: 920,
        minHeight: 190,
    };
}
