...
2. **The built-in vocabulary stays primitive.** The bootstrap model provides
   ...
   scheme/host/port/authority/path-prefix/path-extension constraints, and media-type essence, type, subtype,
...
`@uriRequiresAuthority`, `@uriPathPrefixes`, `@uriPathExtensions`, `@mediaTypes`, and
