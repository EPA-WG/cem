...
2. **The built-in vocabulary stays primitive.** The bootstrap model provides
   ...
   scheme/host/port/authority/path-prefix/path-extension/path-basename/query/query-parameter-name/value/forbidden-parameter/required-parameter/fragment constraints, and media-type essence, type, subtype,
