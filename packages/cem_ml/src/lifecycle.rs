...
use crate::schema::registry::{
    ...
    CLI_COMMAND_SCHEMA_URI, CSS_CONTENT_TYPE, CSS_SCHEMA_URI, CSS_SELECTOR_CONTENT_TYPE,
    CSS_SELECTOR_SCHEMA_URI, CSV_CONTENT_TYPE, CSV_SCHEMA_URI, HTML_CONTENT_TYPE,
    HTML_NAMESPACE_URI, HTML_SCHEMA_URI, JSON_CONTENT_TYPE, JSON_SCHEMA_CONTENT_TYPE,
    JSON_SCHEMA_SCHEMA_URI, JSON_VALUE_SCHEMA_URI, MARKDOWN_CONTENT_TYPE, MARKDOWN_SCHEMA_URI,
    MATHML_CONTENT_TYPE, MATHML_NAMESPACE_URI, MATHML_SCHEMA_URI, MODULE_MAP_CONTENT_TYPE,
    ...
    STUDIO_PROJECT_JSON_CONTENT_TYPE, STUDIO_PROJECT_SCHEMA_URI, SVG_CONTENT_TYPE,
    SVG_NAMESPACE_URI, SVG_SCHEMA_URI, XHTML_CONTENT_TYPE, XHTML_SCHEMA_URI, XML_CONTENT_TYPE,
    XML_SCHEMA_URI, XPATH_CONTENT_TYPE, XPATH_SCHEMA_URI, XSLT_CONTENT_TYPE, XSLT_NAMESPACE_URI,
...
fn matches_json_identity(identity: &FormatIdentity) -> bool {
    ...
    if let Some(content_type) = identity.content_type.as_deref() {
        return match content_type_essence(content_type).as_str() {
            JSON_CONTENT_TYPE | "text/json" => identity.schema.is_none() || explicit_schema_matches,
