...
try {
    ...
    console.log(
        `cem-components package verified (${packedFiles.length} packed files, autocomplete, divider, expansion, progress-spinner, sort-header, paginator, slider, tooltip, and timepicker owners included, ` +
