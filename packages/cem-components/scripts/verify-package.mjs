...
if (!sourcePrimitives.includes("tag: 'cem-sort-header'")) {
    throw new Error('source primitive inventory must contain cem-sort-header');
}

if (!builtPrimitives.includes("tag: 'cem-sort-header'")) {
...
if (!sourcePrimitives.includes("tag: 'cem-slider'")) {
    throw new Error('source primitive inventory must contain cem-slider');
}

if (!builtPrimitives.includes("tag: 'cem-slider'")) {
...
if (!builtPrimitives.includes("tag: 'cem-timepicker'")) {
    throw new Error('built primitive inventory must contain cem-timepicker');
}

if (!sourcePrimitives.includes("tag: 'cem-datepicker'")) {
    throw new Error('source primitive inventory must contain cem-datepicker');
}

if (!builtPrimitives.includes("tag: 'cem-datepicker'")) {
...
if (!sourcePrimitives.includes("tag: 'cem-tree'") || !sourcePrimitives.includes("tag: 'cem-tree-item'")) {
    throw new Error('source primitive inventory must contain cem-tree and cem-tree-item');
}

if (!builtPrimitives.includes("tag: 'cem-tree'") || !builtPrimitives.includes("tag: 'cem-tree-item'")) {
...
if (!existsSync(builtTimepickerBehaviorPath)) {
    throw new Error('built package must contain the timepicker behavior artifact');
}
...
if (!existsSync(builtTreeBehaviorPath)) {
    throw new Error('built package must contain the tree behavior artifact');
}
