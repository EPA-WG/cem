...
pub const FUNCTIONS: &[StdlibFunction] = &[
    ...
    StdlibFunction::native(MODULE_URI, "split", 2, Tier::A),
    StdlibFunction::native_range(MODULE_URI, "trim", 1, 2, Tier::A),
    StdlibFunction::native_range(MODULE_URI, "trim_start", 1, 2, Tier::A),
    StdlibFunction::native_range(MODULE_URI, "trim_end", 1, 2, Tier::A),
    StdlibFunction::native(MODULE_URI, "char_at", 2, Tier::A),
    StdlibFunction::native(MODULE_URI, "at", 2, Tier::A),
    StdlibFunction::native_range(MODULE_URI, "index_of", 2, 3, Tier::A),
    StdlibFunction::native_range(MODULE_URI, "last_index_of", 2, 3, Tier::A),
    ...
    StdlibFunction::native_range(MODULE_URI, "normalize_space", 1, 2, Tier::A),
