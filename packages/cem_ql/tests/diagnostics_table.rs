...
use cem_ql::diagnostics::{
    self, ABORTED, BUDGET_EXCEEDED, CLOSURE_DETACHED, CROSS_TYPE_COMPARE, DATA_BINDING_MISSING,
    DECLARATION_DUPLICATE, IMPORT_ALIAS_DUPLICATE, IMPORT_DENIED, IMPORT_UNRESOLVED,
    MODULE_URL_BLOCKED, MODULE_URL_INVALID, MODULE_URL_POLICY_DENIED, MODULE_URL_UNAVAILABLE,
    MODULE_URL_REFERRER_INVALID, MODULE_URL_REFERRER_SCOPE_DENIED,
    MODULE_URL_REFERRER_UNAVAILABLE, MODULE_URL_REFERRER_UNRESOLVED, MODULE_URL_UNRESOLVED,
    PARSE_ERROR, POLICY_ACCESSOR_FAILED, READ_DENIED, READ_DYNAMIC_ACCEPTS, READ_UNSATISFIABLE,
    RESERVED_SCHEME, SCOPE_VIOLATION, TYPE_ERROR, UNKNOWN_FUNCTION, UNKNOWN_TYPE, UNKNOWN_VARIABLE,
    UNRESOLVED_REFERENCE, USE_RUST_BOOLEAN_OPS,
};
...
fn tier_a_diagnostic_table_matches_impl_section_8_codes() {
    let expected = [
        ...
        (MODULE_URL_INVALID, Severity::Error),
        (MODULE_URL_UNRESOLVED, Severity::Error),
        (MODULE_URL_BLOCKED, Severity::Error),
        (MODULE_URL_POLICY_DENIED, Severity::Error),
        (MODULE_URL_UNAVAILABLE, Severity::Error),
        (MODULE_URL_REFERRER_INVALID, Severity::Error),
        (MODULE_URL_REFERRER_UNRESOLVED, Severity::Error),
        (MODULE_URL_REFERRER_UNAVAILABLE, Severity::Error),
        (MODULE_URL_REFERRER_SCOPE_DENIED, Severity::Error),
    ];
