...
use cem_ql::diagnostics::{
    ...
    MODULE_URL_REFERRER_UNRESOLVED, MODULE_URL_UNAVAILABLE, MODULE_URL_UNRESOLVED, PARSE_ERROR,
    POLICY_ACCESSOR_FAILED, READ_DENIED, READ_DYNAMIC_ACCEPTS, READ_UNSATISFIABLE, RESERVED_SCHEME,
    SCOPE_VIOLATION, TYPE_ERROR, UNKNOWN_FUNCTION, UNKNOWN_TYPE, UNKNOWN_VARIABLE,
