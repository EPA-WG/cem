...
const outputRoot = resolve(workspaceRoot, 'dist/packages/cem-ml-cli-npm');
...
const releaseEvidence = emitNpmReleaseEvidence({
    ...
    outputRoot,
    archivePath,
    coordinate: 'universal-cli-npm',
    runtimeManifestPath: resolve(projectRoot, 'dist/cem-ml-cli-runtime.json'),
