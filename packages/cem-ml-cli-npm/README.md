...
POSIX-compatible quoting, but never perform variable expansion, substitution,
redirection, pipelines, globbing, or command execution. Parsed options still
flow through the same generated command grammar.
