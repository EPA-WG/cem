...
fn schema_owned_validation_examples() -> Vec<ValidationExample> {
    vec![
        ...
        ValidationExample {
            name: "cem-ql operators and control",
            path: "packages/cem_ml/schema-packages/cem-ql/v1/examples/operators-and-control.cemql",
            content_type: CEM_QL_CONTENT_TYPE,
            schema_uri: CEM_QL_SCHEMA_URI,
            expected_exit: EXIT_OK,
            expected_diagnostics: &[],
        ...
        ValidationExample {
            name: "cem-ql collections and pipelines",
            path: "packages/cem_ml/schema-packages/cem-ql/v1/examples/collections-and-pipelines.cemql",
            content_type: CEM_QL_CONTENT_TYPE,
            schema_uri: CEM_QL_SCHEMA_URI,
            expected_exit: EXIT_OK,
            expected_diagnostics: &[],
        ...
        ValidationExample {
            name: "cem-ql stdlib data helpers",
            path: "packages/cem_ml/schema-packages/cem-ql/v1/examples/stdlib-data-helpers.cemql",
            content_type: CEM_QL_CONTENT_TYPE,
            schema_uri: CEM_QL_SCHEMA_URI,
            expected_exit: EXIT_OK,
            expected_diagnostics: &[],
        ...
        ValidationExample {
            name: "cem-ql host resource helpers",
            path: "packages/cem_ml/schema-packages/cem-ql/v1/examples/host-resource-helpers.cemql",
            content_type: CEM_QL_CONTENT_TYPE,
            schema_uri: CEM_QL_SCHEMA_URI,
            expected_exit: EXIT_OK,
            expected_diagnostics: &[],
        ...
        ValidationExample {
            name: "cem-ql invalid old syntax",
            path: "packages/cem_ml/schema-packages/cem-ql/v1/examples/invalid-old-syntax.cemql",
            content_type: CEM_QL_CONTENT_TYPE,
            schema_uri: CEM_QL_SCHEMA_URI,
            expected_exit: EXIT_HARD_FAILURE,
            expected_diagnostics: &["cem.ql.use_rust_boolean_ops"],
        },
        ValidationExample {
