...
- [ ] Enable schema behavior, including `{diagnostic}` behavior, to be defined
  ...
  - [x] Add schema-package and CLI examples for every engine-provided algorithm
        ...
        constraints, plus path prefix/extension/basename, URI scheme/host/port/authority/path-prefix/path-extension/query/query-parameter-name/value/forbidden-parameter/required-parameter/fragment, and media-type
