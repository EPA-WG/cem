...
| ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The `cem_ml` Rust crate is built as `cdylib` and `rlib`.                                                                                          | One semantic implementation can target native and WASM.                              | Publish generated JS/WASM bindings as the planned `@epa-wg/cem-ml` npm package. The workspace does not currently contain its `package.json`.                                          |
