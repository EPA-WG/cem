...
- [Figma sample token application](../examples/figma/sample-token-application.md) — fixture for applying variables to
  a button and card.
- [Semantic login fixture](../examples/semantic/login.html)
- [Semantic registration fixture](../examples/semantic/registration.html)
- [Semantic profile fixture](../examples/semantic/profile.html)
- [Semantic assets list fixture](../examples/semantic/assets-list.html)
- [Semantic message thread fixture](../examples/semantic/message-thread.html)
